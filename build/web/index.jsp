<%-- 
    Document   : index
    Created on : 18/09/2020, 17:00:10
    Author     : Wilmer
--%>
...
<html>
    ...
    <body>
        <h1 align="center" style="color:#EC0D50">Productos</h1>
        <h4 align="center"><b>Nombre:</b> Wilmer Alexis Martínez Sal &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Carnet:</b> 1290-19-13930</h4>
        <button style="margin-left: 128px;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_producto" onclick="limpiar()">Nuevo</button>
